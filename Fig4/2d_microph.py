...
cmap = 'YlGnBu_r'
cont = ax[0].pcolormesh(diff_CC['x']*1000, diff_CC['y']*1000,
                        (diff_CC.CC)*100,
                        transform=proj, cmap='RdBu_r')
cont2 = ax[1].pcolormesh(diff_COD['x']*1000, diff_COD['y']*1000,
                         diff_COD.COD,
                         transform=proj, cmap='RdBu_r')
cont3 = ax[2].pcolormesh(diff_LWP['x']*1000, diff_LWP['y']*1000,
                         diff_LWP.CWP, transform=proj, cmap='RdBu_r')
cont4 = ax[3].pcolormesh(diff_IWP['x']*1000, diff_IWP['y']*1000,
