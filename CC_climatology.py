...
if __name__ == '__main__':
    ...
    ax[1].pcolormesh(clim_AVHRR_regrid['lon'], clim_AVHRR_regrid['lat'],
                     clim_AVHRR_regrid, transform=ccrs.PlateCarree(), vmin=0, vmax=100, cmap=cmap)
    ax[3].pcolormesh(clim_MODIS_regrid['lon'], clim_MODIS_regrid['lat'],
                     clim_MODIS_regrid, transform=ccrs.PlateCarree(), vmin=0, vmax=100, cmap=cmap)
    ax[2].pcolormesh(ERA_summer_mean['lon'], ERA_summer_mean['lat'],
